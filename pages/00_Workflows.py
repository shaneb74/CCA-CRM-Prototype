...
# 00_Workflows.py — Workflows hub (hidden from sidebar, routable)
import streamlit as st
st.set_page_config(page_title="Workflows", page_icon="🧭", layout="wide")  # must be first Streamlit call

import store
from ui_chrome import hide_pages

# Hide this hub link from the sidebar
